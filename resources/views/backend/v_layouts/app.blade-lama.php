...
<head>
	...
	<title>Heira Studio Tegal</title>
	...
	<link rel="stylesheet" href="{{ asset('backend/azzara/assets/css/demo.css') }}">
</head>
<body>
	<div class="wrapper">
		<!--
		...
		<div class="main-header" data-background-color="purple">
			...
			<div class="logo-header">
				...
				<a href="index.html" class="logo">
					<img src="{{ asset('backend/azzara/assets/img/logoazzara.svg') }}" alt="navbar brand" class="navbar-brand">
				</a>
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('backend/azzara/assets/img/jm_denis.jpg') }}" alt="Img Profile">
												</div>
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('backend/azzara/assets/img/chadengle.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('backend/azzara/assets/img/mlane.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('backend/azzara/assets/img/talha.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{ asset('backend/azzara/assets/img/profile2.jpg') }}" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg"><img src="{{ asset('backend/azzara/assets/img/profile.jpg') }}" alt="image profile" class="avatar-img rounded"></div>
										<div class="u-text">
											<h4>Hizrian</h4>
...
<script src="{{ asset('backend/azzara/assets/js/setting-demo.js') }}"></script>
<script src="{{ asset('backend/azzara/assets/js/demo.js') }}"></script>
</body>
</html>