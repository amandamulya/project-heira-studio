                                ...
                                <table class="table table-bordered" id="tablepegawai">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> {{ $row->customer ? $row->customer->nama : 'Nama tidak tersedia' }} </td>
                                            <td> {{ $row->tgl_pesan }} </td>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{ route('pesanan.destroy', $row->id) }}" style="display: inline-block;">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger btn-sm show_confirm" data-toggle="tooltip" title='Delete' onclick="confirm('apakah yakin akan menghapus data ini?')"><i class="fa fa-trash"></i> Hapus</button>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
